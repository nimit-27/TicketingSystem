...
### UI/API Sub Version: prod-1.16.2

This subversion belongs to the `1.16` release line and is intentionally documented inside `prod-1.16.md`.
...
Image:
bom.ocir.io/bmozxse0db74/prod_ticketing_system:ticketing-ui_prod_v1.16.2
...
Image:
bom.ocir.io/bmozxse0db74/prod_ticketing_system:ticketing-api_prod_v1.16.3
