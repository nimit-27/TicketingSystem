...
INSERT INTO `notification_master` VALUES (1,'TICKET_CREATED','Ticket Created','Triggered when a new ticket is logged in the system.','Ticket {{ticketId}} created','Hello {{recipientName}}, ticket {{ticketId}} has been created by {{initiatorName}}.','/email/TicketCreated.ftl','TicketCreated.ftl','ticket_created_inapp.html','[\"EMAIL\", \"SMS\", \"IN_APP\"]',_binary '','2025-01-10 09:00:00.000000','2026-01-27 14:01:28.734021'),(2,'TICKET_STATUS_UPDATE','Ticket Status Updated','Alerts requestors when ticket status changes.','Ticket {{ticketId}} status updated','Ticket {{ticketNumber}} changed from {{oldStatus}} to {{newStatus}}.','ticket_status_update_email.html','TKT_STATUS_UPDATE','ticket_status_update_inapp.html','[\"EMAIL\", \"SMS\", \"IN_APP\"]',_binary '','2025-01-10 09:05:00.000000','2025-12-22 01:37:42.254489'),(3,'TICKET_FEEDBACK_REMINDER','Ticket Feedback Reminder','Reminder to share feedback after resolution.','Feedback pending for ticket {{ticketId}}','Hi {{recipientName}}, please provide feedback for ticket {{ticketNumber}} resolved on {{resolvedDate}}.',NULL,NULL,'ticket_feedback_inapp.html','[\"IN_APP\"]',_binary '','2025-01-10 09:10:00.000000','2025-09-29 03:44:59.277083'),(4,'TICKET_ASSIGNED','Ticket Assigned','Notifies the assignee when a ticket is assigned to them.','Ticket {{ticketId}} assigned to you','Ticket {{ticketId}} has been assigned to you.','/email/TicketAssigned.ftl','TicketAssigned.ftl','ticket_assigned_inapp.html','[\"EMAIL\", \"SMS\", \"IN_APP\"]',_binary '','2025-01-10 09:15:00.000000','2026-01-27 14:01:28.736011'),(5,'TICKET_UPDATED','Ticket Updated','Alerts requestors when key ticket details are updated, such as assignment changes.','Ticket {{ticketId}} updated','Ticket {{ticketNumber}} has been updated.',NULL,NULL,'ticket_updated_inapp.html','[\"IN_APP\"]',_binary '','2025-01-10 09:20:00.000000','2025-12-22 02:57:24.996039'),(6,'TICKET_SLA_BREACHED','Ticket SLA Breached','Alerts assignees when an assigned ticket breaches its SLA.','Ticket {{ticketId}} breached SLA','Ticket {{ticketNumber}} has breached its SLA by {{breachedByMinutes}} minutes. Please review and take corrective action.','ticket_sla_breached_email.html',NULL,'ticket_sla_breached_inapp.html','[\"IN_APP\"]',_binary '','2025-01-10 09:25:00.000000','2025-09-29 03:44:59.280145'),(7,'TICKET_ASSIGNED_REQUESTER','Ticket Assigned - Requester','Notifies the requester when their ticket assignment is updated.','Ticket {{ticketId}} assigned','Hello {{recipientName}}, your ticket {{ticketId}} has been assigned.','ticket_assigned_requester_email.html',NULL,'ticket_assigned_requester_inapp.html','[\"EMAIL\", \"IN_APP\"]',_binary '','2025-01-10 09:30:00.000000','2025-12-22 01:37:42.252780'),(8,'TICKET_RESOLVED','Ticket Resolved','Notifies the requester when their ticket has been resolved.','Ticket {{ticketId}} resolved',NULL,'/email/TicketResolved.ftl','TicketResolved.ftl',NULL,'[\"EMAIL\", \"SMS\", \"IN_APP\"]',_binary '','2026-01-27 12:41:28.749152','2026-01-27 14:01:28.736269'),(9,'TICKET_LINKED_TO_MASTER','Ticket Linked to Master Ticket','Notifies the requester if their ticket has been linked to a master ticket.',NULL,NULL,'/email/TicketLinkedToMaster.ftl','TicketLinkedToMaster.ftl',NULL,'[\"EMAIL\", \"SMS\", \"IN_APP\"]',_binary '','2026-01-27 12:41:28.755854','2026-01-27 14:01:28.736473');
...
-- Dump completed on 2026-01-27 19:33:12
