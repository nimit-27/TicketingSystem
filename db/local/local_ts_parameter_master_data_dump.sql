...
INSERT INTO `parameter_master` VALUES ('1','ALL','All','Represents all stakeholders or users involved'),('2','ASSIGNED_TO','Assigned To','Represents the user assigned to handle the ticket'),('3','CREATED_BY','Created By','Shows the user who created the ticket'),('4','UPDATED_BY','Updated By','Shows the user who last updated the ticket'),('5','REQUESTED_BY','Requested By','Indicates the user who requested the ticket');
...
-- Dump completed on 2025-12-10 23:17:49
