...
--
-- Table structure for table `assigned_back_from_fci_flag_backup`
--

DROP TABLE IF EXISTS `assigned_back_from_fci_flag_backup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `assigned_back_from_fci_flag_backup` (
  `ticket_id` varchar(36) NOT NULL,
  `previous_is_assigned_back_from_fci` tinyint(1) NOT NULL,
...
--
-- Table structure for table `cr_status_master`
--

DROP TABLE IF EXISTS `cr_status_master`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cr_status_master` (
  `cr_status_id` varchar(255) NOT NULL,
  `cr_status_name` varchar(255) NOT NULL,
  `cr_status_code` varchar(255) NOT NULL,
  ...
  PRIMARY KEY (`cr_status_id`),
  UNIQUE KEY `cr_status_code` (`cr_status_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `division_history`
--

DROP TABLE IF EXISTS `division_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `division_history` (
  `division_history_id` varchar(36) NOT NULL,
  `ticket_id` varchar(255) NOT NULL,
  `updated_by` varchar(100) DEFAULT NULL,
  `previous_division` varchar(20) DEFAULT NULL,
  `current_division` varchar(20) DEFAULT NULL,
  `timestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `remark` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`division_history_id`),
  KEY `fk_division_history_ticket` (`ticket_id`),
...
CREATE TABLE `notification_master` (
  ...
  `email_personalized` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`),
...
CREATE TABLE `notification_recipient` (
  ...
  KEY `idx_nr_status_retry` (`status`,`next_retry_at`),
  KEY `idx_nr_notification_status` (`notification_id`,`status`),
...
CREATE TABLE `page_master` (
  ...
  `page_order` bigint DEFAULT NULL,
...
CREATE TABLE `parameter_master` (
  `parameter_id` varchar(2) NOT NULL,
...
--
-- Table structure for table `report_artifact`
--
...
CREATE TABLE `report_artifact` (
  ...
  KEY `idx_report_artifact_request_id` (`request_id`),
  CONSTRAINT `report_artifact_ibfk_1` FOREIGN KEY (`request_id`) REFERENCES `report_request_history` (`request_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=212 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `report_column_mapping`
--

DROP TABLE IF EXISTS `report_column_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `report_column_mapping` (
  ...
  UNIQUE KEY `uk_report_column` (`report_id`,`column_key`),
  KEY `idx_report_column_mapping_report_id` (`report_id`),
  CONSTRAINT `report_column_mapping_ibfk_1` FOREIGN KEY (`report_id`) REFERENCES `report_master` (`report_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `report_filter_mapping`
--

DROP TABLE IF EXISTS `report_filter_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `report_filter_mapping` (
  ...
  `default_value` text,
  `option_source_type` varchar(100) DEFAULT NULL,
  ...
  UNIQUE KEY `uk_report_filter` (`report_id`,`filter_id`),
  KEY `idx_report_filter_mapping_report_id` (`report_id`),
  CONSTRAINT `report_filter_mapping_ibfk_1` FOREIGN KEY (`report_id`) REFERENCES `report_master` (`report_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `report_request_history`
--

DROP TABLE IF EXISTS `report_request_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `report_request_history` (
  `request_id` varchar(36) NOT NULL,
  `report_id` bigint NOT NULL,
  `requested_by` varchar(36) NOT NULL,
  `status` varchar(50) NOT NULL,
  `output_format` varchar(50) NOT NULL,
  `selected_columns_json` json DEFAULT NULL,
  ...
  KEY `idx_report_request_history_report_id` (`report_id`),
  KEY `idx_report_request_history_status` (`status`),
  CONSTRAINT `report_request_history_ibfk_1` FOREIGN KEY (`report_id`) REFERENCES `report_master` (`report_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `role_notification_channel_mapping`
--

DROP TABLE IF EXISTS `role_notification_channel_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `role_notification_channel_mapping` (
  ...
  UNIQUE KEY `uq_role_notification_channel_mapping` (`role_id`,`notification_type_id`,`channel_code`),
  KEY `idx_rncm_role_notification_active` (`role_id`,`notification_type_id`,`is_active`),
  KEY `idx_rncm_notification_channel_active` (`notification_type_id`,`channel_code`,`is_active`),
...
CREATE TABLE `role_permission_config` (
  ...
  `allowed_status_action_ids` varchar(100) DEFAULT NULL,
  `allowed_cr_status_action_ids` varchar(255) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `role_id` int NOT NULL AUTO_INCREMENT,
  `parameter_ids` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`role_id`)
...
--
-- Table structure for table `sla_calculation_job_run`
--

DROP TABLE IF EXISTS `sla_calculation_job_run`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sla_calculation_job_run` (
  `sla_calculation_job_run_id` varchar(36) NOT NULL,
  `trigger_type` varchar(20) NOT NULL,
  `scope` varchar(30) NOT NULL DEFAULT 'ACTIVE_ONLY',
  `run_status` varchar(40) NOT NULL,
  `triggered_by` varchar(120) DEFAULT NULL,
  `started_at` datetime NOT NULL,
  `completed_at` datetime DEFAULT NULL,
  `duration_ms` bigint DEFAULT NULL,
  `total_candidate_tickets` bigint DEFAULT NULL,
  `processed_tickets` bigint DEFAULT NULL,
  `succeeded_tickets` bigint DEFAULT NULL,
  `failed_tickets` bigint DEFAULT NULL,
  `batch_size` int DEFAULT NULL,
  `error_summary` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`sla_calculation_job_run_id`),
  KEY `idx_sla_job_run_started_at` (`started_at`),
  KEY `idx_sla_job_run_status` (`run_status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `status_history` (
  ...
  `remark` varchar(255) DEFAULT NULL,
  `timestamp_utc` timestamp(6) NULL DEFAULT NULL,
  `created_at_utc` timestamp(6) NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `ticket_cr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ticket_cr` (
  ...
  `updated_by` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ticket_cr_id`),
  KEY `idx_ticket_cr_ticket_id` (`ticket_id`),
  KEY `idx_ticket_cr_status_id` (`status_id`),
  KEY `idx_ticket_cr_cr_status_id` (`cr_status_id`),
...
--
-- Table structure for table `ticket_cr_history`
--

DROP TABLE IF EXISTS `ticket_cr_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ticket_cr_history` (
  ...
  KEY `idx_ticket_cr_history_ticket_cr_id` (`ticket_cr_id`),
  KEY `idx_ticket_cr_history_ticket_id` (`ticket_id`),
  KEY `idx_ticket_cr_history_change_group_id` (`change_group_id`),
  KEY `idx_ticket_cr_history_change_type_code` (`change_type_code`),
  KEY `idx_ticket_cr_history_changed_on` (`changed_on`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ticket_cr_history_config`
--

DROP TABLE IF EXISTS `ticket_cr_history_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ticket_cr_history_config` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `ticket_cr_sequences`
--

DROP TABLE IF EXISTS `ticket_cr_sequences`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ticket_cr_sequences` (
  `id` varchar(20) NOT NULL,
  `sequence_date` date NOT NULL,
  `last_value` bigint NOT NULL,
  `version` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `sequence_date` (`sequence_date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ticket_cr_status_workflow`
--

DROP TABLE IF EXISTS `ticket_cr_status_workflow`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ticket_cr_status_workflow` (
  `crsw_id` varchar(20) NOT NULL,
  ...
  PRIMARY KEY (`crsw_id`),
  KEY `fk_ticket_cr_status_workflow_current_status` (`current_status_id`),
  KEY `fk_ticket_cr_status_workflow_next_status` (`next_status_id`),
  CONSTRAINT `fk_ticket_cr_status_workflow_current_status` FOREIGN KEY (`current_status_id`) REFERENCES `cr_status_master` (`cr_status_id`),
  CONSTRAINT `fk_ticket_cr_status_workflow_next_status` FOREIGN KEY (`next_status_id`) REFERENCES `cr_status_master` (`cr_status_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ticket_sla` (
  ...
  `ticket_id` varchar(36) NOT NULL,
  `sla_id` varchar(36) DEFAULT NULL,
...
CREATE TABLE `tickets` (
  ...
  `issue_type_id` varchar(3) DEFAULT NULL,
  `last_modified_status_date` datetime DEFAULT NULL,
  `division` varchar(20) DEFAULT NULL,
  `is_assigned_back_from_fci` tinyint(1) NOT NULL DEFAULT '0',
  `created_at_utc` timestamp(6) NULL DEFAULT NULL,
  `last_modified_utc` timestamp(6) NULL DEFAULT NULL,
  `last_modified_status_date_utc` timestamp(6) NULL DEFAULT NULL,
  `version` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`ticket_id`),
  KEY `idx_tickets_mode_id` (`mode_id`),
  KEY `master_id` (`master_id`),
  KEY `fk_tickets_issue_type` (`issue_type_id`),
  KEY `idx_reported_date` (`reported_date`),
  KEY `fk_tickets_division` (`division`),
  CONSTRAINT `fk_tickets_division` FOREIGN KEY (`division`) REFERENCES `division_master` (`division_id`),
  CONSTRAINT `fk_tickets_issue_type` FOREIGN KEY (`issue_type_id`) REFERENCES `issue_type_master` (`issue_type_id`),
...
-- Dump completed on 2026-06-22 10:51:49
