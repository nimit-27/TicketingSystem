...
//      Ticket Id Generator
    ...
    public Page<TicketDto> searchTickets(String query, String statusId, Boolean master,
                                         ...
                                         String severity, String createdBy, String category, String subCategory, String issueTypeId,
        ...
        Page<Ticket> page = ticketRepository.searchTickets(query, statusIds, master, assignedTo, assignedBy, requestorId, levelId, priority, severityFilters, createdBy, category, subCategory, issueTypeId, from, to, pageable);
    ...
    public List<TicketDto> searchTicketsList(String query, String statusId, Boolean master,
        ...
        LocalDateTime from = DateTimeUtils.parseToLocalDateTime(fromDate);
        LocalDateTime to = DateTimeUtils.parseToLocalDateTime(toDate);
        return ticketRepository.searchTicketsList(query, statusIds, master, assignedTo, assignedBy, requestorId, levelId, priority, severityFilters, createdBy, category, subCategory, issueTypeId, from, to)
                .stream()
